...
declare module "@salesforce/schema/OpportunityChangeEvent.DB_Competitor__c" {
  const DB_Competitor__c:string;
  export default DB_Competitor__c;
}
declare module "@salesforce/schema/OpportunityChangeEvent.Data_Quality_Description__c" {
  const Data_Quality_Description__c:string;
  export default Data_Quality_Description__c;
}
declare module "@salesforce/schema/OpportunityChangeEvent.Data_Quality_Score__c" {
