...
declare module "@salesforce/schema/ContactChangeEvent.Data_Quality_Description__c" {
  const Data_Quality_Description__c:string;
  export default Data_Quality_Description__c;
}
declare module "@salesforce/schema/ContactChangeEvent.Employment_Type__c" {
  const Employment_Type__c:string;
  export default Employment_Type__c;
}
declare module "@salesforce/schema/ContactChangeEvent.Data_Quality_Score__c" {
...
declare module "@salesforce/schema/ContactChangeEvent.Amount__c" {
  const Amount__c:number;
  export default Amount__c;
}
declare module "@salesforce/schema/ContactChangeEvent.Secret_Key__c" {
  const Secret_Key__c:string;
  export default Secret_Key__c;
}
declare module "@salesforce/schema/ContactChangeEvent.Start_Date__c" {
  const Start_Date__c:any;
  export default Start_Date__c;
}
declare module "@salesforce/schema/ContactChangeEvent.Termination_Date__c" {
  const Termination_Date__c:any;
  export default Termination_Date__c;
}
declare module "@salesforce/schema/ContactChangeEvent.Employment_Status__c" {
  const Employment_Status__c:string;
  export default Employment_Status__c;
}
