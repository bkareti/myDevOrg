...
declare module "@salesforce/schema/Task.DB_Activity_Type__c" {
  const DB_Activity_Type__c:string;
  export default DB_Activity_Type__c;
}
declare module "@salesforce/schema/Task.Data_Quality_Description__c" {
  const Data_Quality_Description__c:string;
  export default Data_Quality_Description__c;
}
declare module "@salesforce/schema/Task.Data_Quality_Score__c" {
