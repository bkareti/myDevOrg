...
declare module "@salesforce/schema/Lead.DB_Created_Date_without_Time__c" {
  const DB_Created_Date_without_Time__c:any;
  export default DB_Created_Date_without_Time__c;
}
declare module "@salesforce/schema/Lead.DB_Lead_Age__c" {
  const DB_Lead_Age__c:number;
  export default DB_Lead_Age__c;
}
declare module "@salesforce/schema/Lead.Data_Quality_Description__c" {
  const Data_Quality_Description__c:string;
  export default Data_Quality_Description__c;
}
declare module "@salesforce/schema/Lead.Data_Quality_Score__c" {
