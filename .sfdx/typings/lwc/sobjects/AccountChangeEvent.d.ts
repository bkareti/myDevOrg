...
declare module "@salesforce/schema/AccountChangeEvent.Address__c" {
  const Address__c:string;
  export default Address__c;
}
declare module "@salesforce/schema/AccountChangeEvent.Hosp_Type__c" {
  const Hosp_Type__c:string;
  export default Hosp_Type__c;
}
declare module "@salesforce/schema/AccountChangeEvent.Customer_ID__c" {
  const Customer_ID__c:string;
  export default Customer_ID__c;
}
declare module "@salesforce/schema/AccountChangeEvent.Data_Quality_Description__c" {
  const Data_Quality_Description__c:string;
  export default Data_Quality_Description__c;
}
declare module "@salesforce/schema/AccountChangeEvent.Data_Quality_Score__c" {
  const Data_Quality_Score__c:number;
  export default Data_Quality_Score__c;
}
declare module "@salesforce/schema/AccountChangeEvent.Language_Preference__c" {
  const Language_Preference__c:string;
  export default Language_Preference__c;
}
declare module "@salesforce/schema/AccountChangeEvent.Number_of_Contacts__c" {
  const Number_of_Contacts__c:string;
  export default Number_of_Contacts__c;
}
declare module "@salesforce/schema/AccountChangeEvent.MyExtID__c" {
  const MyExtID__c:string;
  export default MyExtID__c;
}
declare module "@salesforce/schema/AccountChangeEvent.RichText__c" {
  const RichText__c:string;
  export default RichText__c;
}
